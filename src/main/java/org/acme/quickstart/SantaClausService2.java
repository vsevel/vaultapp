...
@ApplicationScoped
public class SantaClausService2 {

    private static final Logger log = Logger.getLogger(SantaClausService2.class.getName());
    ...
    private AgroalDataSource getDatasource(String dsname) {
        return dsname.equals("static") ? dataSource1 : dataSource2;
    }
